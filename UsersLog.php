...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated" style="color: #fff;">Here are the Students daily logs</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Filter / Export to Excel</button>
    </div>
    <!-- Log filter -->
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Filter By Students:</b></label>
                    <select class="card_sel" name="card_sel" id="card_sel">
                      ...
                      ?>
                              <option value="<?php echo $row['card_uid'];?>"><?php echo $row['name']; echo" "; echo $row['surname'];?></option>
                      <?php
                            }
                        }
                      ?>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filter By Bus:</b></label>
