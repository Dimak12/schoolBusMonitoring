...
<main>
	<h1 class="slideInDown animated" style="color: #fff;">Add/Update/Delete Students</h1>
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<fieldset>
				...
				<input type="text" name="card_uid" id="card_uid" placeholder="Card ID...">
				...
				<input type="text" name="number" id="number" placeholder="Relative Phone Number...">
				
			</fieldset>
			<fieldset>
			
			<label>
				<label for="Device"><b>Bus ID:</b></label>
